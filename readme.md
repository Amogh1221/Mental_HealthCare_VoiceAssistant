...
- **Chrome/Edge Required**: Safari and Firefox have limited support
- **HTTPS Required**: For production, use HTTPS or localhost
...
- Reduce `BATCH_SIZE` in `build_vectordb.py`
- Use smaller embedding models
- Reduce retrieval `k` value in `rag_engine.py`
